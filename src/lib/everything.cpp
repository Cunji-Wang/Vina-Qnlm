...
everything::everything() { // enabled according to design.out227
	...
	add(1, new gauss(0, 0.8, cutoff)); // offset, width, cutoff // WEIGHT: -0.035579
	...
	//Ximing
	add(1, new hydrophobic(0.0, 2.5, cutoff)); // good, bad, cutoff // WEIGHT:  -0.035069
...
//	Ximing
	add(1, new non_dir_h_bond(-0.6, 0, cutoff)); // good, bad, cutoff // WEIGHT:  -0.587439
