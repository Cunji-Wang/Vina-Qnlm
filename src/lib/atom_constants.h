...
const sz XS_TYPE_C_A   =  2;
const sz XS_TYPE_N_P   =  3;
const sz XS_TYPE_N_D   =  4;
const sz XS_TYPE_N_A   =  5;
const sz XS_TYPE_N_DA  =  6;
const sz XS_TYPE_O_P   =  7;
const sz XS_TYPE_O_D   =  8;
const sz XS_TYPE_O_A   =  9;
const sz XS_TYPE_O_DA  = 10;
const sz XS_TYPE_S_P   = 11;
const sz XS_TYPE_S_H   = 12;
const sz XS_TYPE_P_P   = 13;
const sz XS_TYPE_F_H   = 14;
const sz XS_TYPE_Cl_H  = 15;
const sz XS_TYPE_Br_H  = 16;
const sz XS_TYPE_I_H   = 17;
const sz XS_TYPE_Met_D = 18;
const sz XS_TYPE_SIZE  = 19;
